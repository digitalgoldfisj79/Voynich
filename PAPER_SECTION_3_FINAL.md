...
implementation is available at [GITHUB_REPOSITORY_URL].
...
radiocarbon) documented experimentation with:
   ...
   **Mnemonic encoding:** *Ars Notoria* manuscripts from northern Italy 
   ...
   Example: Venice, Biblioteca Marciana MS Lat. III, 102 (c. 1410s) employs 
...
1. **Abbreviation system comparison** (6-12 months):
   ...
   - Medical compendium abbreviation patterns from specific manuscripts:
     * Padua, Biblioteca Universitaria MS 194 (medical glossary, c. 1420)
     * Venice, Biblioteca Marciana MS Lat. XIV, 223 (pharmaceutical, c. 1430)
...
**Code Repository:** [GITHUB_URL] - Complete Python implementation of 
