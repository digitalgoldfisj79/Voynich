...
MIN_CLUSTER_COUNT = 30       # how many uncovered types in cluster
MIN_CORPUS_HITS = 50         # how many total token hits in corpus
MIN_PATTERN_LEN = 2
...
def load_phase69_patterns(path):
    ...
    # Handle both formats: {"rules":[...]} or plain list
...
def load_clusters(path):
    ...
    with open(path, "r", encoding="utf-8") as f:
        ...
        # Expect something like: section  pre  suf  cluster_count  corpus_hits
        for parts in reader:
