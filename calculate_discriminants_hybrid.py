...
def get_voynich_baseline():
    ...
    IMPORTANT: This is the SUBSET used for Rugg comparison (7,045 tokens).
    - Subset MI1: 1.687
    - Full corpus MI1: 1.49 (29,687 tokens)
    
    Why use subset?
    - Has complete FSM validation (Phase69)
    - Has complete suffix extraction (PhaseM)
    - Matches prior hoax studies for comparability
    
    See Appendix for detailed explanation of corpus selection.
    """
    return {
        'name': 'voynich_subset',
        'n_tokens': 7045,
        ...
        'len_stdev': 2.17,
        'H1': 3.990,
        'MI1': 1.687,  # SUBSET value (full corpus = 1.49)
        'n_suffixes': 63,
        'coverage': 0.786,
...
def main():
    ...
    print("="*80)
    print()
    print("IMPORTANT: Voynich baseline uses SUBSET (7,045 tokens)")
    print("  - Subset MI1: 1.69 (used for this comparison)")
    print("  - Full corpus MI1: 1.49 (29,687 tokens)")
    print("  - Subset has complete FSM + suffix analysis")
    print("  - See Appendix for detailed explanation")
    print()
    ...
    print("  - Uses SUBSET (7,045 tokens, MI1 = 1.69)")
    print("  - Full corpus has 29,687 tokens (MI1 = 1.49)")
    print("  - Subset chosen for complete FSM + suffix analysis")
    ...
    print()
    print("IMPORTANT: Manuscript should note corpus selection")
    print("  • Main paper: Use full corpus MI1 = 1.49")
    print("  • Table 5 (Rugg): Use subset MI1 = 1.69")
    print("  • Appendix: Explain difference (see appendix_rugg_comparison.md)")
